...
class TestOrder(unittest.TestCase):
    ...
    def test_get_by_id(self):
        ...
        id = '5f861d48bad93599bac66235'
        response = self.app.post('/orders'+ str(id),
            headers={"Content-Type": "application/json"},
            data=json.dumps(order_payload))

        response = self.app.get('/orders'+str(id))
    ...
    def test_delete_order(self):
        ...
        response = self.app.delete('/orders/'+ str(id))
    ...
    def test_update_item(self):
        ...
        response = self.app.patch('/orders/'+ str(id))
    ...
    def test_update_order(self):
        ...
        response = self.app.put('/orders/'+ str(id))
