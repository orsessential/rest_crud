# CRUD Rest API
this repository used to implement crud (create, read, update, delete) function using python flask dan mongoDB. this repository also provide unittest (on process)
...
## Setup ##
```
git clone https://github.com/orsessential/rest_crud
python app.py
